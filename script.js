/* Váriaveis de controle de interface*/
...
/* Váriaveis de controle de ambiente*/
let etapaAtual = 0;
let numero = '';
...
function clicou(n){
   ...
   if(elNumero !== null){
       ...
       if(elNumero.nextSibling !== null){ 
            elNumero.nextElementSibling.classList.add('pisca'); //encotra o próximo elemento mais próximo
        }else{ 
            atualizaInterface();
        }
    }
